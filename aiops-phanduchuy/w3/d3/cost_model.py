...
if __name__ == "__main__":
    ...
    # Scenario 3: Medium-large E-Commerce Platform (Custom Scenario)
    # -------------------------------------------------------------
    ...
    # Total Downtime Cost = ~$50,000/hour (conservative estimate).
    print("Scenario 3 (Custom E-Commerce Platform - 150 services):")
    res3 = is_worth_it(
        num_services=150,
